...
puts describe "Playlister Basics" do
...
puts   describe "show pages" do
    ...
    puts describe "/genres/:slug" do
      ...
      puts it "contains links to each song's show page" do
        expect(page).to have_css("a[href='/songs/#{@song.slug}']")
      end
    end
  end
