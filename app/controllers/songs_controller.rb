...
use Rack::Flash
  ...
  post '/songs/:slug' do
    ...
    if Artist.all.find {|artist| artist.name == params[:artist]}
      @song.artist = Artist.all.find {|artist| artist.name == params[:artist]}
    else
  ...
  get '/songs/:slug/edit' do
   ...
   patch '/songs/:slug' do
     @song = Song.all.find {|song| song.name == params[:name]}
