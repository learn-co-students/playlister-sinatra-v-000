...
song1 = Song.create(name: "song1", artist: artist1, genres:[genre1,genre2])
#song1.genres << genre1
song2 = Song.create(name: "song1a", artist: artist1)
#song2.genres << genre1
artist2 = Artist.create(name: "Artist2")
song3 = Song.create(name: "song3", artist: artist2)
song4 = Song.create(name: "song4", artist: artist2)
#song3.genres << genre1
#song4.genres << genre1
#song4.genres << genre2
